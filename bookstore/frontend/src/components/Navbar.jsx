...
useEffect(()=>{
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container dark:bg-slate-900 dark:text-white mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50  ${sticky ? "sticky-navbar shadow-md bg-base-300 duration-300 transition-all ease-in-out dark:bg-slate-900 dark:text-white":""}`}>
  ...
  <div className="navbar-start">
    ...
    <Link to="/" className="btn btn-ghost text-2xl font-bold cursor-pointer">BookStore</Link>
  </div>
  ...
  <label className=" flex items-center px-3 py-1 border rounded-md gap-2">
...
<label className="swap swap-rotate">
  ...
  <div>
    <a className="bg-black text-white py-2 px-4 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById("my_modal_3").showModal()}>login</a>
  </div>
  </div>
